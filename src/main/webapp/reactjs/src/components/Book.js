...
export default class Book extends Component {
    ...
    submitBook(event){
        alert('Title: ' + this.state.title + ' , Author:' + this.state.author + ', Cover P URL: ' + this.state.coverPhotoURL
        + ', Isbn Number: ' + this.state.isbnNumber + ', Price: ' + this.state.price + ' , Language: ' + this.state.language);
